...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div *ngIf=\"loading\" class=\"spinner-wrapper\">\n  <div class=\"lds-ring\"><div></div><div></div><div></div><div></div></div>\n</div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnnouncementConst", function() { return AnnouncementConst; });
...
/* harmony import */ var _core_helper_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../core/helper.service */ "./src/app/core/helper.service.ts");
/* harmony import */ var _announcement_constant__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./announcement.constant */ "./src/app/announcements/announcement.constant.ts");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var _core_load_worker_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../core/load-worker.service */ "./src/app/core/load-worker.service.ts");
...
let AnnouncementService = class AnnouncementService {
    constructor(httpClient, helperService, loadWorkerService) {
    ...
    fetchAnnouncements(event = null) {
        const url = this.helperService.getResourceUrl(_announcement_constant__WEBPACK_IMPORTED_MODULE_4__["AnnouncementConst"].ANNOUNCEMENTS, false);
    ...
    fetchFilteredAnnouncements(month, year) {
        const url = this.helperService.getResourceUrl(`${_announcement_constant__WEBPACK_IMPORTED_MODULE_4__["AnnouncementConst"].ANNOUNCEMENTS}?_sort=date:ASC&month=${month}&year=${year}`, false);
        return this.httpClient.get(url).subscribe(val => {
            this.announcements$.next(val);
            this.loadWorkerService.announcementLoad$.next(false);
        }, err => this.handleError(err));
    ...
    fetchAnnouncement(id) {
        const url = this.helperService.getResourceUrl(`${_announcement_constant__WEBPACK_IMPORTED_MODULE_4__["AnnouncementConst"].ANNOUNCEMENTS}/${id}`, false);
        return this.httpClient.get(url).subscribe(val => {
...
AnnouncementService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"],
        ...
        _core_load_worker_service__WEBPACK_IMPORTED_MODULE_6__["LoadWorkerService"]])
], AnnouncementService);
...
const routes = [
    ...
    {
        path: 'announcements',
        loadChildren: () => Promise.all(/*! import() | announcements-announcements-module */[__webpack_require__.e("default~announcements-announcements-module~connect-connect-module~events-events-module~ministries-mi~1667ac5e"), __webpack_require__.e("announcements-announcements-module")]).then(__webpack_require__.bind(null, /*! ./announcements/announcements.module */ "./src/app/announcements/announcements.module.ts")).then(m => m.AnnouncementsPageModule)
    },
    {
        path: 'events',
        loadChildren: () => Promise.all(/*! import() | events-events-module */[__webpack_require__.e("default~announcements-announcements-module~connect-connect-module~events-events-module~ministries-mi~1667ac5e"), __webpack_require__.e("events-events-module")]).then(__webpack_require__.bind(null, /*! ./events/events.module */ "./src/app/events/events.module.ts")).then(m => m.EventsPageModule)
    },
    {
        path: 'prayer-requests',
        loadChildren: () => Promise.all(/*! import() | prayer-requests-prayer-requests-module */[__webpack_require__.e("default~announcements-announcements-module~connect-connect-module~events-events-module~ministries-mi~1667ac5e"), __webpack_require__.e("prayer-requests-prayer-requests-module")]).then(__webpack_require__.bind(null, /*! ./prayer-requests/prayer-requests.module */ "./src/app/prayer-requests/prayer-requests.module.ts")).then(m => m.PrayerRequestsPageModule)
    },
    {
        path: 'ministries',
        loadChildren: () => Promise.all(/*! import() | ministries-ministries-module */[__webpack_require__.e("default~announcements-announcements-module~connect-connect-module~events-events-module~ministries-mi~1667ac5e"), __webpack_require__.e("ministries-ministries-module")]).then(__webpack_require__.bind(null, /*! ./ministries/ministries.module */ "./src/app/ministries/ministries.module.ts")).then(m => m.MinistriesPageModule)
    },
    {
        path: 'connect',
        loadChildren: () => Promise.all(/*! import() | connect-connect-module */[__webpack_require__.e("default~announcements-announcements-module~connect-connect-module~events-events-module~ministries-mi~1667ac5e"), __webpack_require__.e("connect-connect-module")]).then(__webpack_require__.bind(null, /*! ./connect/connect.module */ "./src/app/connect/connect.module.ts")).then(m => m.ConnectPageModule)
    },
    {
        path: 'give',
        loadChildren: () => __webpack_require__.e(/*! import() | give-give-module */ "give-give-module").then(__webpack_require__.bind(null, /*! ./give/give.module */ "./src/app/give/give.module.ts")).then(m => m.GivePageModule)
    },
];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("ion-grid ion-row {\n  padding: 3vh 0;\n}\n\nion-header ion-toolbar {\n  display: flex;\n}\n\nion-header ion-toolbar img {\n  width: 60%;\n  vertical-align: middle;\n  margin-left: 2%;\n}\n\nmain-bg-color {\n  background-color: blue;\n}\n\n.selected {\n  box-shadow: rgba(0, 0, 0, 0.12) 0px 4px 16px;\n}\n\nion-col {\n  height: 20%;\n  padding: 0px !important;\n}\n\nion-item {\n  --background-activated: transparent !important;\n}\n\nion-item {\n  direction: rtl !important;\n  --inner-padding-end: 0px !important;\n  --inner-padding-start: 0px !important;\n  --padding-start:0px;\n}\n\nion-item ion-label {\n  font-size: 13px !important;\n  margin: 0px;\n  padding: 0px;\n  position: relative;\n  color: #E02E2E;\n}\n\nion-item ion-label ion-row {\n  display: block;\n  text-align: center;\n}\n\nion-item ion-label ion-icon {\n  font-size: 40px;\n}\n\nion-label.disabled-label {\n  background-color: #f3f3f3;\n  opacity: 0.7;\n}\n\n@media (max-width: 340px) {\n  ion-item {\n    direction: rtl !important;\n  }\n  ion-item ion-label {\n    font-size: 10px !important;\n    margin: 0px;\n    padding: 0px;\n    position: relative;\n    left: 5%;\n    color: #E02E2E;\n  }\n  ion-item ion-label ion-row {\n    display: block;\n    text-align: center;\n  }\n  ion-item ion-label ion-icon {\n    font-size: 40px;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _shared_services_menu_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./shared/services/menu.service */ "./src/app/shared/services/menu.service.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, screenOrientation, menuService) {
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
        ...
        _shared_services_menu_service__WEBPACK_IMPORTED_MODULE_7__["MenuService"]])
], AppComponent);
...
/* harmony import */ var _announcements_announcement_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./announcements/announcement.service */ "./src/app/announcements/announcement.service.ts");
...
/* harmony import */ var _helper_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helper.service */ "./src/app/core/helper.service.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _utils_RequestInterceptor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/RequestInterceptor */ "./src/app/core/utils/RequestInterceptor.ts");
...
/* harmony import */ var _loader_loader_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./loader/loader.component */ "./src/app/core/loader/loader.component.ts");
...
let HelperService = class HelperService {
    constructor() { }
    getResourceUrl(resourceUrl, isAsset = false) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LoadWorkerService", function() { return LoadWorkerService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let LoadWorkerService = class LoadWorkerService {
    constructor() {
        this.announcementLoad$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](true);
    }
};
LoadWorkerService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
...
LoaderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-loader',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./loader.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/core/loader/loader.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./loader.component.css */ "./src/app/core/loader/loader.component.css")).default]
    }),
...
let MenuService = class MenuService {
    ...
    fetchMenuReference() {
        const url = this.helperService.getResourceUrl(src_app_app_constants__WEBPACK_IMPORTED_MODULE_4__["AppConstants"].MENU_URL, false);
...
module.exports = __webpack_require__(/*! /Users/elizabethharris/Documents/projects/faith-mobile/src/main.ts */"./src/main.ts");
